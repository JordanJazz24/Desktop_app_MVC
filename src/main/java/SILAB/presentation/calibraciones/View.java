    ...
    public View() {
        ...
        save.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                try {
                    Calibracion instrumentoActual = new Calibracion(numero.getText(), model.getCurrent().getInstrumento(), fechas.getText());
                    if ( controller.model.getMode() == Application.modeMedicion) {

                        controller.actualizarMediciones(getMedicionesFromTable());

                        instrumentoActual.setMediciones(model.getListMediciones());
                        ...
                        instrumentoActual.setMediciones(listaMedi); // setea la lista de mediciones al objeto calibracion
