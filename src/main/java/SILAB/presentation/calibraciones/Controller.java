...
public class Controller{
    ...
    public Controller(View view, Model model) {
        ...
        model.setMedicionActual(new SILAB.logic.Medicion());
        this.view = view;
        this.model = model;
...
//        }
    ...
    public void search2(Calibracion filter) throws  Exception{
        List<Calibracion> rows = Service.instance().search2(filter);
    ...
    public void edit(int row){
        ...
        try {
            ...
            model.setListMediciones(Service.instance().listaMediciones(model.getCurrent()));
            model.commit();
        } catch (Exception ex) {}
    ...
    public void setInstrumento(Instrumento current) {
        ...
        model.setList(Service.instance().findCalibrationsForInstrument(current)); //carga solo las calibraciones del instrumento seleccionado
    ...
    public void deleteMedicion() {
       Service.instance().deleteMedicionForCalibracion(model.getCurrent(),model.getMedicionActual());
        model.setListMediciones(Service.instance().listaMediciones(model.getCurrent()));
